...
<section class="dashboard">
   ...
   <div class="box-container">
      ...
      <div class="box">
      <?php
         $select_messages = $conn->prepare("SELECT * FROM `stock`");
         $select_messages->execute();
         $number_of_messages = $select_messages->rowCount();
      ?>
      <h3><?= $number_of_messages; ?></h3>
      <p>total feedback</p>
      <a href="admin_contacts.php" class="btn">see feedback</a>
      </div>
      ...
      <?php
         ...
         $number_of_stock = $select_stock->rowCount();
      ?>
      <h3><?= $number_of_stock; ?></h3>
      <p>out of stock</p>
      <a href="admin_out_stock.php" class="btn">see out of stock</a>
      </div>
